...
* Extract the archive and upload (or git clone) it's contents (modernize.js, js and css directories) from it to *rah_modernize* directory placed to the root of your site, next to the *textpattern* directory.
* Done.